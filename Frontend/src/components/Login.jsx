    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          ...
          {/* Header */}
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-gray-900">Log in and start sharing.</h2>
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm text-gray-900 caret-blue-600 bg-white dark:bg-gray-800 dark:text-gray-100 text-gray-900 caret-blue-600 bg-white dark:bg-gray-800 dark:text-gray-100"
          ...
          <div className="mt-8 text-xs text-gray-500">
            By logging in with an account, you agree to MiniLink's{' '}
      ...
      <div className="hidden lg:flex lg:flex-1 lg:flex-col lg:justify-center lg:px-8 bg-gray-100">
        <div className="mx-auto max-w-md text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">
            Connect Bitly to the tools you use every day.
          </h3>
