                ...
                <form onSubmit={handleCreateLink} className="space-y-4">
                  ...
                  <div className="flex justify-center">
                    <FloatingButton
                      type="submit"
                      disabled={isCreating}
                      className="bg-linear-to-r from-blue-600 via-purple-600 to-blue-700 text-white py-3 px-6 rounded-lg font-bold text-sm hover:from-blue-700 hover:via-purple-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-200 disabled:opacity-50 shadow-lg hover:shadow-xl"
                    >
                      {isCreating ? (
